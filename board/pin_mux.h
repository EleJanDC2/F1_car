 ...
 *
 */
void BOARD_InitISPIPins(void); /* Function assigned for the Cortex-M0P */
...
/* Symbols to be used with GPIO driver */
#define MOTORA_BackwardA_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define MOTORA_BackwardA_GPIO_PIN_MASK (1U << 16U) /*!<@brief GPIO pin mask */
#define MOTORA_BackwardA_PORT 0U                   /*!<@brief PORT device index: 0 */
#define MOTORA_BackwardA_PIN 16U                   /*!<@brief PORT pin number */
#define MOTORA_BackwardA_PIN_MASK (1U << 16U)      /*!<@brief PORT pin mask */
                                                   /* @} */
...
/* Symbols to be used with GPIO driver */
#define MOTORA_ForwardA_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define MOTORA_ForwardA_GPIO_PIN_MASK (1U << 17U) /*!<@brief GPIO pin mask */
#define MOTORA_ForwardA_PORT 0U                   /*!<@brief PORT device index: 0 */
#define MOTORA_ForwardA_PIN 17U                   /*!<@brief PORT pin number */
#define MOTORA_ForwardA_PIN_MASK (1U << 17U)      /*!<@brief PORT pin mask */
                                                  /* @} */
 ...
 *
 */
void MotorA(void); /* Function assigned for the Cortex-M0P */
...
/* Symbols to be used with GPIO driver */
#define SERVO_TurnRight_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define SERVO_TurnRight_GPIO_PIN_MASK (1U << 13U) /*!<@brief GPIO pin mask */
#define SERVO_TurnRight_PORT 0U                   /*!<@brief PORT device index: 0 */
#define SERVO_TurnRight_PIN 13U                   /*!<@brief PORT pin number */
#define SERVO_TurnRight_PIN_MASK (1U << 13U)      /*!<@brief PORT pin mask */
                                                  /* @} */
...
/* Symbols to be used with GPIO driver */
#define SERVO_TurnLeft_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define SERVO_TurnLeft_GPIO_PIN_MASK (1U << 12U) /*!<@brief GPIO pin mask */
#define SERVO_TurnLeft_PORT 0U                   /*!<@brief PORT device index: 0 */
#define SERVO_TurnLeft_PIN 12U                   /*!<@brief PORT pin number */
#define SERVO_TurnLeft_PIN_MASK (1U << 12U)      /*!<@brief PORT pin mask */
                                                 /* @} */
 ...
 *
 */
void Servo(void); /* Function assigned for the Cortex-M0P */
